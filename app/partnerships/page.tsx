...
export default async function PartnershipsPage({ searchParams }: Props) {
    ...
    const rows = await getEntityTable("partnership", ay)
        ...
        <div className="container mx-auto px-4 md:px-8 py-12 space-y-16">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-extrabold tracking-tight">Partnership Firms</h1>
            ...
            <Suspense fallback={<TableSkeleton />}>
                {taxRates && (
                    <TaxTable
                        title="Tax Rates & Surcharges"
                        subtitle="Flat rate taxation for Firms and LLPs"
            ...
            <Suspense fallback={<TableSkeleton />}>
                {provisions && (
                    <TaxTable
                        ...
                        subtitle="Remuneration limits and compliance"
